  ...
  const handleClick = () => {
	...
	return (
      ...
      <nav>
				...
				<CustomLink href='/about' title='Sobre PBX' className='mx-4' />
				<CustomLink href='/projects' title='Proyectos' className='ml-4' />
			</nav>
			
			<nav className='flex items-center justify-center flex-wrap'>
				<motion.a href='https://github.com/polsze' target={"_blank"} whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3'><GithubIcon /></motion.a>
				<motion.a href='https://www.linkedin.com/in/pablo-barrios-2ba888231/' target={"_blank"} whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mx-3'><LinkedInIcon /></motion.a>
			</nav>
      </div>
      ...
      <nav className='flex items-center flex-col justify-center'>
				...
				<CustomMobileLink href='/about' title='Sobre PBX' className='' toggle={handleClick} />
