...
import Jungla from '../../public/images/profile/code-bg.webp'
          ...
          '>
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center '>
              ...
              <p className='my-4 text-lg font-medium text-white md:text-sm sm:text-xs'>
                Desarrollo de páginas web modernas y adaptables a diferentes dispositivos, basadas en interfaces orientadas en la fluida experiencia del usuario. Navegá y visitá los proyectos realizados.              </p>
